...
setwd("/Users/brianvaine/Desktop/Eastern U/DS For Business/Module Data")
...
#               3 samples    whole data set                 set the split at 60/20/20
...
# only x or predictor variables, the predicted is removed
xsdf<-Train[c(-2)]
View(xsdf)
...
#         ~. means use all other predictor variable
set.seed(42)
...
#function is glm.
#                             leaving out CustomerID family is binary
options(scipen=999)
...
#         pred fxn    lst of pribs scores $ actual values
